...
public class WifiSearch extends Activity {
    TextView mainText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainText = (TextView) findViewById(R.id.txt_DestinationIP);
    ...
    private final BroadcastReceiver mWifiScanReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context c, Intent intent) {
            if (intent.getAction().equals(mainWifi.SCAN_RESULTS_AVAILABLE_ACTION)) {
